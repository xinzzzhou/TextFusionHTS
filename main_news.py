...
def config_args():
    ...
    parser.add_argument('--data_path', type=str, default=os.getcwd()+'/datasets/News/', help='data dir, options: [PixelLens, Wiki_people, taobao_fashion, News]')
    ...
    # parser.add_argument('--data_path', type=str, default='/home/xinz/ar57_scratch/xinz/MMTS'+'/datasets/News/', help='data file')
    # parser.add_argument('--output_path', type=str, default='/home/xinz/ar57_scratch/xinz/MMTS'+'/MMTS_output/', help='output path')
    parser.add_argument('--data_ts_filename', type=str, default='GooglePlus_Palestine_transpose_final.csv', help='data filename')
    parser.add_argument('--data_tx_filename', type=str, default='GooglePlus_Palestine_txt_final_eos_emb_llama3.csv', help='data filename')
    ...
    # ts model
    parser.add_argument('--ts_model', type=str, default='PatchTST', help='time series model name, options: [PatchTST]')
    ...
    parser.add_argument('--seasonality', type=int, default=3, help='seasonality')
    parser.add_argument('--inverse', action='store_true', help='inverse output data', default=False)
    parser.add_argument('--revin', action='store_true', default=True, help='whether to use revin')
    # patchtst
